...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 03 déc. 2019 à 09:01
...
--
-- Base de données :  `bd_football_scores_v2`
--
...
CREATE TABLE IF NOT EXISTS `match` (
  `id` int(50) NOT NULL,
  `homeTeam` int(50) NOT NULL,
  `awayTeam` int(50) NOT NULL,
  `homeTeamLogo` int(50) NOT NULL,
  `awayTeamLogo` int(50) NOT NULL,
  `status` varchar(50) NOT NULL,
  `date` varchar(50) NOT NULL,
  `time` varchar(50) NOT NULL,
  `homeTeamScore` varchar(50) NOT NULL,
  `awayTeamScore` varchar(50) NOT NULL,
  `winner` varchar(50) NOT NULL,
  `homeTeamVote` varchar(50) NOT NULL,
  `awayTeamVote` varchar(50) NOT NULL,
  `competition` int(50) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `indexHomeTeam` (`homeTeam`),
  KEY `indexAwayTeam` (`awayTeam`),
  KEY `indexHomeTeamLogo` (`homeTeamLogo`),
  KEY `IndexAwayTeamLogo` (`awayTeamLogo`),
  KEY `indexCompetition` (`competition`)
...
INSERT INTO `match` (`id`, `homeTeam`, `awayTeam`, `homeTeamLogo`, `awayTeamLogo`, `status`, `date`, `time`, `homeTeamScore`, `awayTeamScore`, `winner`, `homeTeamVote`, `awayTeamVote`, `competition`) VALUES
(1, 2, 3, 2, 3, 'fini', '01/01/2020', '15:00', '2', '0', '2', '50', '50', 1);
...
DROP TABLE IF EXISTS `tbl_inscription`;
CREATE TABLE IF NOT EXISTS `tbl_inscription` (
...
--
ALTER TABLE `match`
  ADD CONSTRAINT `c5` FOREIGN KEY (`competition`) REFERENCES `tbl_competition` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
